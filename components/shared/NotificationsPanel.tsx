...
export const NotificationsPanel = ({
  ...
  const renderContent = (isScreen = false) => (
    <View
      className={isScreen ? 'flex-1 bg-white' : 'flex-1 rounded-bl-3xl rounded-tl-3xl bg-white'}
      style={isScreen ? undefined : styles.panelShadow}>
      {/* Header */}
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        {notifications.length > 0 ? (
          ...
          <View className="flex-1 items-center justify-center pt-32">
            ...
            <Text className="mt-4 text-base font-medium text-textSecondary">All caught up!</Text>
          </View>
        )}
      </ScrollView>
    </View>
